...
public class Police2Officer : MonoBehaviour
{
    ...
    private void Update() {
        ...
        if((playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level3 == true) || (playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level4 == true) || (playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level5 == true)) {
            ChasePlayer();
        }
        if((playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level3 == true) || (playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level4 == true) || (playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level5 == true)) {
            ShootPlayer();
