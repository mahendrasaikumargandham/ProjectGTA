...
public class PoliceOfficer : MonoBehaviour
{
    ...
    private void Update() {
        ...
        if((!playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level1 == false) || (!playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level2 == false) || (!playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level3 == false) || (!playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level4 == false) || (!playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level5 == false)) {
            Walk();
        }
        if((playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level1 == true) || (playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level2 == true) || (playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level3 == true) || (playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level4 == true) || (playerInVisionRadius && !playerInShootingRadius && wantedLevelScript.level5 == true)) {
            ChasePlayer();
        }
        if((playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level1 == true) || (playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level2 == true) || (playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level3 == true) || (playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level4 == true) || (playerInVisionRadius && playerInShootingRadius && wantedLevelScript.level5 == true)) {
            ShootPlayer();
